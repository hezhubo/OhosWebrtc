...
#ifndef SDK_OHOS_SRC_AUDIO_DEVICE_OHAUDIO_PLAYER_WRAPPER_H
#define SDK_OHOS_SRC_AUDIO_DEVICE_OHAUDIO_PLAYER_WRAPPER_H
...
namespace webrtc {
class OHAudioPlayerObserverInterface {
public:
...
protected:
    virtual ~OHAudioPlayerObserverInterface() {}
};

class OHAudioPlayerWrapper {
public:
    OHAudioPlayerWrapper(const AudioParameters& audio_parameters,
                         OH_AudioStream_Type direction,
                         OHAudioPlayerObserverInterface* observer);
    ~OHAudioPlayerWrapper();
    ...
    OHAudioPlayerObserverInterface* observer() const;
    ...
    OH_AudioRenderer* stream() const { return stream_; }
...
private:
    ...
    OHAudioPlayerObserverInterface* observer_ = nullptr;
    OH_AudioRenderer* stream_ = nullptr;
    int32_t frames_per_burst_ = 0;
};
}  // namespace webrtc

#endif  // SDK_OHOS_SRC_AUDIO_DEVICE_OHAUDIO_PLAYER_WRAPPER_H
